...
const LogJson = [
	...
	{ url: "/api/activity/planning/add", opCode: "1", opType: "添加", module: "德育活动-德育规划", func: (body) => "添加:" + body.headline },
	{ url: "/api/activity/planning/changeIsTop", opCode: "4", opType: "置顶/取消置顶", module: "德育活动-德育规划", func: (body) => (body.isTop === 1 ? "置顶id:" : "取消置顶id:") + body.id },
	{ url: "/api/activity/planning/del", opCode: "0", opType: "删除", module: "德育活动-德育规划", func: (body) => "删除id:" + body.id },
	{ url: "/api/activity/planning/edit", opCode: "2", opType: "编辑", module: "德育活动-德育规划", func: (body) => "编辑id:" + body.id },
	{ url: "/api/activity/pacesetter/edit", opCode: "2", opType: "编辑", module: "德育活动-德育标兵", func: (body) => "编辑id:" + body.id },
	{ url: "/api/activity/pacesetter/add", opCode: "1", opType: "添加", module: "德育活动-德育标兵", func: (body) => "添加:" + body.name },
	{ url: "/api/activity/pacesetter/del", opCode: "0", opType: "删除", module: "德育活动-德育标兵", func: (body) => "删除id:" + body.id },
	{ url: "/api/activity/pacesetter/move", opCode: "3", opType: "移动", module: "德育活动-德育标兵", func: (body) => "id:"  + body.fromId + (body.fromOrder < body.toOrder ? "上移" : "下移") },
	{ url: "/api/activity/health/add", opCode: "1", opType: "添加", module: "德育活动-健康教育", func: (body) => "添加:" + body.headline },
	{ url: "/api/activity/health/changeIsTop", opCode: "4", opType: "置顶/取消置顶", module: "德育活动-健康教育", func: (body) => (body.isTop === 1 ? "置顶id:" : "取消置顶id:") + body.id },
	{ url: "/api/activity/health/del", opCode: "0", opType: "删除", module: "德育活动-健康教育", func: (body) => "删除id:" + body.id },
	{ url: "/api/activity/health/edit", opCode: "2", opType: "编辑", module: "德育活动-健康教育", func: (body) => "编辑id:" + body.id },
	{ url: "/api/activity/culture/add", opCode: "1", opType: "添加", module: "德育活动-班级文化", func: (body) => "添加:" + body.headline },
	{ url: "/api/activity/culture/changeIsTop", opCode: "4", opType: "置顶/取消置顶", module: "德育活动-班级文化", func: (body) => (body.isTop === 1 ? "置顶id:" : "取消置顶id:") + body.id },
	{ url: "/api/activity/culture/del", opCode: "0", opType: "删除", module: "德育活动-班级文化", func: (body) => "删除id:" + body.id },
	{ url: "/api/activity/culture/edit", opCode: "2", opType: "编辑", module: "德育活动-班级文化", func: (body) => "编辑id:" + body.id },
	{ url: "/api/activity/teacher/add", opCode: "1", opType: "添加", module: "德育活动-班主任专栏", func: (body) => "添加:" + body.headline },
	{ url: "/api/activity/teacher/changeIsTop", opCode: "4", opType: "置顶/取消置顶", module: "德育活动-班主任专栏", func: (body) => (body.isTop === 1 ? "置顶id:" : "取消置顶id:") + body.id },
	{ url: "/api/activity/teacher/del", opCode: "0", opType: "删除", module: "德育活动-班主任专栏", func: (body) => "删除id:" + body.id },
	{ url: "/api/activity/teacher/edit", opCode: "2", opType: "编辑", module: "德育活动-班主任专栏", func: (body) => "编辑id:" + body.id },
	{ url: "/api/activity/gym/add", opCode: "1", opType: "添加", module: "德育活动-体艺活动", func: (body) => "添加:" + body.headline },
	{ url: "/api/activity/gym/changeIsTop", opCode: "4", opType: "置顶/取消置顶", module: "德育活动-体艺活动", func: (body) => (body.isTop === 1 ? "置顶id:" : "取消置顶id:") + body.id },
	{ url: "/api/activity/gym/del", opCode: "0", opType: "删除", module: "德育活动-体艺活动", func: (body) => "删除id:" + body.id },
	{ url: "/api/activity/gym/edit", opCode: "2", opType: "编辑", module: "德育活动-体艺活动", func: (body) => "编辑id:" + body.id },
	...
	{ url: "/api/party/project/changeIsTop", opCode: "4", opType: "置顶/取消置顶", module: "二中党建-活动项目", func: (body) => (body.isTop === 1 ? "置顶id:" : "取消置顶id:") + body.id },
	...
	{ url: "/api/establish/practice/add", opCode: "1", opType: "添加", module: "二中党建-新时代文明实践活动", func: (body) => "添加:" + body.headline },
	{ url: "/api/establish/practice/changeIsTop", opCode: "4", opType: "置顶/取消置顶", module: "二中党建-新时代文明实践活动", func: (body) => (body.isTop === 1 ? "置顶id:" : "取消置顶id:") + body.id },
	{ url: "/api/establish/practice/del", opCode: "0", opType: "删除", module: "二中党建-新时代文明实践活动", func: (body) => "删除id:" + body.id },
	{ url: "/api/establish/practice/edit", opCode: "2", opType: "编辑", module: "二中党建-新时代文明实践活动", func: (body) => "编辑id:" + body.id },
